...
<head>
    ...
    <meta name="description" content="Manage your Al Barr account settings, shipping address details, and payment preferences for fast, organic farm delivery.">
    <title>My Profile - Al Barr | Kashmiri Organic Staples</title>
...
<body>
        ...
        <div class="profile-container">
            ...
            <div class="profile-guest-card" id="profile-guest-view" style="display: none;">
                ...
                <div class="guest-buttons">
                    <a href="signin.php?redirect=profile.php" class="btn-guest-signin">Sign In</a>
                    <a href="signup.php?redirect=profile.php" class="btn-guest-signup">Sign Up</a>
                </div>
            </div>
                ...
                <div class="profile-grid">
                    ...
                    <aside class="profile-sidebar">
                        ...
                        <ul class="profile-side-menu">
                            <li><a href="profile.php" class="profile-side-link active">👤 Personal Profile</a></li>
                        ...
                        <form id="profile-form" onsubmit="handleProfileSave(event)">
                            ...
                            <div class="form-grid">
                                <div class="profile-input-group">
                                    ...
                                    <input type="text" id="prof-name" class="profile-input" required>
                                </div>
                                <div class="profile-input-group">
                                    <label for="prof-email" class="profile-label">Email Address *</label>
                                    <input type="email" id="prof-email" class="profile-input" required disabled>
                                </div>
                                <div class="profile-input-group form-full-row">
                                    <label for="prof-phone" class="profile-label">Mobile Number *</label>
                                    <input type="tel" id="prof-phone" class="profile-input" required>
                                </div>
                            </div>
                            ...
                            <div class="form-grid">
                                <div class="profile-input-group form-full-row">
                                    ...
                                    <input type="text" id="prof-address" class="profile-input" placeholder="e.g. House No., Street, Sector" required>
                                </div>
                                <div class="profile-input-group">
                                    <label for="prof-city" class="profile-label">City *</label>
                                    <input type="text" id="prof-city" class="profile-input" placeholder="e.g. Srinagar" required>
                                </div>
                                <div class="profile-input-group">
                                    <label for="prof-pincode" class="profile-label">Pin Code *</label>
                                    <input type="text" id="prof-pincode" class="profile-input" placeholder="e.g. 190006" required>
                                </div>
                                <div class="profile-input-group form-full-row">
                                    <label for="prof-landmark" class="profile-label">Landmark</label>
                                    <input type="text" id="prof-landmark" class="profile-input" placeholder="e.g. Near University Main Gate">
                                </div>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('prof-city').value = userData.city || 'Srinagar';
            document.getElementById('prof-pincode').value = userData.pincode || '';
            document.getElementById('prof-landmark').value = userData.landmark || '';
            ...
            setTimeout(() => {
                ...
                if (userJson) {
                    try {
                        ...
                        userData.name = document.getElementById('prof-name').value.trim();
                        userData.phone = document.getElementById('prof-phone').value.trim();
                        userData.address = document.getElementById('prof-address').value.trim();
                        userData.city = document.getElementById('prof-city').value.trim();
                        userData.pincode = document.getElementById('prof-pincode').value.trim();
                        userData.landmark = document.getElementById('prof-landmark').value.trim();
                        ...
                        // Sync with desktop dropdown welcomes
                        ...
                        if (typeof AlBarrCart !== 'undefined' && AlBarrCart.showToast) {
                            AlBarrCart.showToast('Profile credentials saved successfully!');
                        } else {
