...
<head>
    ...
    <meta name="description" content="Sign in to your Al Barr account to manage your orders, shipping details, and access premium organic Kashmiri staples.">
    <title>Sign In - Al Barr | Kashmiri Organic Staples</title>
                ...
                <div class="auth-card">
                    ...
                    <form class="auth-form" id="signin-form" onsubmit="event.preventDefault(); handleSignIn();">
                        ...
                        <div class="auth-social-buttons">
                            <button type="button" class="btn-social-auth" onclick="handleSocialSignIn('Google')">
                            ...
                            <button type="button" class="btn-social-auth btn-whatsapp-auth" onclick="handleSocialSignIn('WhatsApp')">
                    ...
                    <div class="auth-footer">
                        ...
                        <a href="signup.php" class="auth-footer-link" id="link-goto-signup">Sign Up</a>
                    </div>
                </div>
    ...
    <script>
        ...
        function togglePasswordVisibility(fieldId) {
            ...
            if (input.type === 'password') {
                input.type = 'text';
                // Change eye to eye-off (add line)
                eyeIcon.innerHTML = `
        ...
        function submitNewPassword() {
            ...
            setTimeout(() => {
                const name = resetIdentifier.includes('@') ? resetIdentifier.split('@')[0] : 'Al Barr Customer';
                const email = resetIdentifier.includes('@') ? resetIdentifier : '';
                const phone = !resetIdentifier.includes('@') ? resetIdentifier : '';
        ...
        function handleSignIn() {
            ...
            // Extract Name from email or mock a name
            let userName = 'Irfan Manzoor'; // default mock
            ...
            const userData = {
                name: userName,
                email: identifier.includes('@') ? identifier : 'user@albarr.com',
                phone: !identifier.includes('@') ? identifier : '9419012345',
                loggedIn: true
            };
            ...
            setTimeout(() => {
                if (typeof AlBarrCart !== 'undefined' && AlBarrCart.showToast) {
                    AlBarrCart.showToast(`Welcome back, ${userName}! Signing in...`);
                }
