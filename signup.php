...
<head>
    ...
    <meta name="description" content="Register an Al Barr account to save shipping details, view previous orders, and enjoy faster organic staples checkout.">
    <title>Sign Up - Al Barr | Kashmiri Organic Staples</title>
    ...
    <style>
        ...
        /* Password Strength Meter Checklist items styling */
        .strength-checklist {
            list-style: none;
            padding: 0;
...
<body>
            ...
            <div class="auth-container">
                ...
                <div class="auth-card">
                    ...
                    <div class="auth-header">
                        ...
                        <p class="auth-subtitle">Join Al Barr organic staples platform</p>
                    </div>
                    ...
                    <form class="auth-form" id="signup-form" onsubmit="event.preventDefault(); handleSignUp();">
                        ...
                        <div class="auth-group">
                            ...
                            <div class="auth-input-wrapper">
                                ...
                                <input type="tel" id="reg-phone" class="auth-input" placeholder="e.g. 9419012345" required pattern="[0-9]{10}">
                            </div>
                        </div>
                        ...
                        <div class="auth-group">
                            ...
                            <div class="auth-input-wrapper">
                                ...
                                <input type="password" id="reg-password" class="auth-input" style="padding-right: 44px;" placeholder="At least 6 characters" required>
                            ...
                            <div class="password-strength-meter" id="pass-strength-meter" style="display: none;">
                                <div class="meter-bar-container">
                                    <div class="meter-bar" id="pass-strength-bar"></div>
                                </div>
                                <span class="meter-text" id="pass-strength-text">Password Strength</span>
                            </div>
                            <!-- Requirement Checklist -->
                            <ul class="strength-checklist" id="reg-password-checklist" style="display: none; margin-top: 8px;">
                                <li class="checklist-item" id="chk-length">
                                    <svg class="chk-icon" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="12" cy="12" r="10"></circle>
                                    </svg>
                                    <span>At least 6 characters</span>
                                </li>
                                <li class="checklist-item" id="chk-case">
                                    <svg class="chk-icon" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="12" cy="12" r="10"></circle>
                                    </svg>
                                    <span>Mix of uppercase &amp; lowercase</span>
                                </li>
                                <li class="checklist-item" id="chk-num-spec">
                                    <svg class="chk-icon" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="12" cy="12" r="10"></circle>
                                    </svg>
                        ...
                        <div class="auth-group">
                            ...
                            <div class="auth-input-wrapper">
                                ...
                                <button type="button" class="password-toggle-btn" onclick="togglePasswordVisibility('reg-confirm-password')" aria-label="Toggle password visibility">
                                    <!-- Eye Icon SVG -->
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width: 20px; height: 20px;">
                                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                        <circle cx="12" cy="12" r="3"></circle>
                            ...
                            <!-- Password Match Indicator -->
                            <span class="password-match-indicator" id="pass-match-indicator"></span>
                        </div>

                        <!-- Terms & Conditions check -->
                        <label class="terms-checkbox-wrap">
                            <input type="checkbox" id="reg-terms" class="terms-checkbox" required>
                            <span>I agree to Al Barr's <a href="terms.php" target="_blank" style="color: var(--color-blue-medium); font-weight: 600;">Terms &amp; Conditions</a> and <a href="privacy.php" target="_blank" style="color: var(--color-blue-medium); font-weight: 600;">Privacy Policy</a>.</span>
                        </label>
                    ...
                    <div class="auth-footer">
                        ...
                        <a href="signin.php" class="auth-footer-link" id="link-goto-signin">Sign In</a>
                    </div>
                </div>
        ...
        <div class="auth-modal-content">
            ...
            <div class="google-auth-box">
                ...
                <div class="google-accounts-list">
                    ...
                    <div class="google-account-item" onclick="selectGoogleAccount('Kashmiri Guest', 'guest.albarr@gmail.com')">
                        <div class="g-avatar" style="background-color: #4A5854;">K</div>
                        <div class="g-info">
                            <span class="g-name">Kashmiri Guest</span>
                            <span class="g-email">guest.albarr@gmail.com</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        regPassword.addEventListener('input', () => {
            ...
            if (val.length > 0) {
                if (score === 1) {
                    ...
                    barWidth = '66%';
                    barColor = '#FBBC05'; // Yellow/Orange
                    strengthLabel = 'Medium';
                } else if (score === 3) {
                    barWidth = '100%';
                    barColor = 'var(--color-blue-dark)'; // Green
        ...
        function handleSignUp() {
            ...
            // Save email/phone in sessionStorage to pre-fill on login page
            ...
            setTimeout(() => {
                ...
                window.location.href = `signin.php${redirectParam}`;
            }, 1200);
        }
        ...
        function selectGoogleAccount(name, email) {
            ...
            setTimeout(() => {
                ...
                if (typeof AlBarrCart !== 'undefined' && AlBarrCart.showToast) {
                    AlBarrCart.showToast(`Welcome, ${name}! Signed up via Google.`);
                }
        ...
        function sendWhatsAppOTP() {
            ...
            // Display slide down push notification simulation
