...
<head>
    ...
    <style>
        ...
        .coupon-input-group .checkout-input {
            flex: 1;
            min-width: 0; /* Prevents flex child from blowing out parent */
        }
        ...
        @media (max-width: 600px) {
            .step-item span:not(.step-num) {
                display: none; /* Hide labels to prevent mobile overflow */
            }
            .step-line {
                width: 30px;
            }
        ...
        /* Hide mobile sticky bottom cart banner on checkout page */
...
<body>
                                ...
                                <div class="bank-details-card-checkout">
                                    ...
                                    <div class="checkout-bank-row">
                                        ...
                                        <span>
                                            ...
                                            <button class="bank-btn-copy-checkout" onclick="event.stopPropagation(); copyTextLocal('0216010100002651', this)">Copy</button>
                                        </span>
                                    </div>
                                    <div class="checkout-bank-row" style="margin-bottom: 0;">
                                        ...
                                        <span>
                                            ...
                                            <button class="bank-btn-copy-checkout" onclick="event.stopPropagation(); copyTextLocal('JAKA0GARDEN', this)">Copy</button>
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // 3. Address Caching: Load from localStorage
